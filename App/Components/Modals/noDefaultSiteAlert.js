...
angular
    ...
    .component('noDefaultSiteAlert',
        {
            templateUrl: 'Components/Modals/noDefaultSiteAlert.html',
            bindings: {
                resolve: '<',
                close: '&',
                dismiss: '&'
            },
            controller: function ($element, $timeout, $rootScope) {
                var $ctrl = this;
                ...
                $ctrl.Cancel = function () {
                    $rootScope.$broadcast('noLandingPageAction', "cancel");
                    $ctrl.close();
                };
                $ctrl.Continue = function () {
                    $rootScope.$broadcast('noLandingPageAction', "continue");
                    $ctrl.dismiss();
                };
            }
